...
{
    global $css;
    $css[$file] = ['id' => $id, 'media' => $media, 'extension' => $extension];
}
...
function js_echo($file, $id = '', $defer = true, $extension = 'js')
{
    ...
    echo PHP_EOL, '<script type="application/javascript" src="', $src, '"', $def, $id_, '></script>';
}
...
{
    global $js;
    $js[$file] = ['id' => $id, 'defer' => $defer, 'extension' => $extension];
}
